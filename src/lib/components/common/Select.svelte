<script lang="ts">
	...
	export let contentClass =
		'rounded-2xl min-w-[170px] p-1 border border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-850 text-gray-900 dark:text-gray-100 shadow-lg';

	/** CSS classes for each item button */
	export let itemClass =
		'flex w-full gap-2 items-center px-3 py-1.5 text-sm cursor-pointer text-gray-700 dark:text-gray-100 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-xl';
