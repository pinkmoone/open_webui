										...
										{#if file.type === 'image' || (file?.content_type ?? '').startsWith('image/')}
											...
											<div class=" relative group">
												...
												<div class=" absolute -top-1 -right-1">
													<button
														class=" bg-white text-black border border-white rounded-full dark:bg-gray-850 dark:text-gray-100 dark:border-gray-700 group-hover:visible invisible transition"
														type="button"
														on:click={() => {
