				...
				>
					{#if !edit}
						<div class="flex flex-col w-full mt-2 mb-1">
							...
							<div class="flex-1">
								...
								>
									<select
										class="w-full text-sm bg-transparent placeholder:text-gray-300 dark:placeholder:text-gray-500 outline-hidden"
										bind:value={type}
									>
					...
					{#if edit}
						<div class="flex w-full mt-2 items-center justify-between">
							...
							<button
								class="text-xs bg-transparent placeholder:text-gray-300 dark:placeholder:text-gray-500 outline-hidden text-left"
								type="button"
								on:click={() => {
