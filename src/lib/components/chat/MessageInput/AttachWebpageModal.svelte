	...
	<div class="flex flex-col h-full">
		...
		<div class="px-5 pb-4">
			...
			>
				...
				<textarea
					id="webpage-url"
					class={`w-full flex-1 text-sm bg-transparent ${($settings?.highContrastMode ?? false) ? 'placeholder:text-gray-700 dark:placeholder:text-gray-100' : 'outline-hidden placeholder:text-gray-300 dark:placeholder:text-gray-400'}`}
					type="text"
					bind:value={url}
					rows="3"
