			...
			<div class="m-auto pb-44 flex flex-col justify-center">
				<div class="max-w-md">
					...
					<div class=" mt-6 mx-auto relative group w-fit">
						<button
							class="relative z-20 flex px-5 py-2 rounded-full bg-gray-100 hover:bg-gray-200 text-black dark:bg-gray-850 dark:hover:bg-gray-800 dark:text-gray-100 transition font-medium text-sm"
							on:click={() => {
								location.href = '/';
							}}
						>
