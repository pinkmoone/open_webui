...
{#if $user}
	<div class="app relative">
		<div class="owui-bg h-screen max-h-[100dvh] overflow-auto flex flex-row justify-end">
			{#if !['user', 'admin'].includes($user?.role)}
				<AccountPending />
			{:else}
				{#if localDBChats.length > 0}
							...
							<div class="m-auto pb-44 flex flex-col justify-center">
								<div class="max-w-md">
									...
									<div class=" mt-6 mx-auto relative group w-fit">
										<button
											class="relative z-20 flex px-5 py-2 rounded-full bg-white border border-gray-100 hover:bg-gray-100 text-gray-700 dark:bg-gray-850 dark:border-gray-800 dark:hover:bg-gray-800 dark:text-gray-100 transition font-medium text-sm"
											on:click={async () => {
