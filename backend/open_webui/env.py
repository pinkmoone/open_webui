...
WEBUI_OPENING_CODE = os.environ.get('WEBUI_OPENING_CODE', '').strip()

try:
    WEBUI_OPENING_CODE_EXPIRES_MINUTES = int(os.environ.get('WEBUI_OPENING_CODE_EXPIRES_MINUTES', '10'))
except ValueError:
    log.warning('Invalid WEBUI_OPENING_CODE_EXPIRES_MINUTES; using default value 10')
    WEBUI_OPENING_CODE_EXPIRES_MINUTES = 10
